...
String iframeSrc = request.getContextPath() + "/reservations/create"; // default for receptionist
...
.brand h3{ margin:0; font-size:14px; letter-spacing:0.8px; text-transform:uppercase; }
...
.userbox .welcome{ font-size:12px; color: var(--muted); margin-bottom:6px; }
...
.logoutForm{ margin-top:auto; padding-top:10px; }
.logoutBtn{
...
.logoutBtn:hover{ filter: brightness(1.05); transform: translateY(-1px); }
...
<div class="container">
    ...
    <div class="sidebar">
        ...
        <div class="nav">
            ...
            <a href="<%= request.getContextPath() %>/staff/reservations" target="contentFrame">All Reservations</a>
        </div>
